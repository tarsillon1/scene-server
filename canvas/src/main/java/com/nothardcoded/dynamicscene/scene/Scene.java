package com.nothardcoded.dynamicscene.scene;

import com.nothardcoded.dynamicscene.scene.exception.NotAssignableException;
...
import com.nothardcoded.dynamicscene.scene.model.property.AsyncSceneObjectPropertyHandler;
...
import com.nothardcoded.dynamicscene.scene.model.strategy.SceneUpdateStrategy;
import com.nothardcoded.dynamicscene.scene.model.strategy.SceneUpdateStrategyBuilder;
...
public class Scene {
  ...
  public void construct(SceneObject sceneObject) {
  ...
  public void registerSceneProperty (SceneProperty sceneProperty) {
    if (!context.getBeanFactory().containsBean(sceneProperty.getName())) {
      BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(sceneProperty.getValue().getClass());
      builder.setScope(BeanDefinition.SCOPE_PROTOTYPE);
      DefaultListableBeanFactory factory = (DefaultListableBeanFactory) context.getBeanFactory();
      factory.registerBeanDefinition(sceneProperty.getName(), builder.getBeanDefinition());
    }
  }
